    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                container.append(btnFirst).append(btnPrev).append(list).append($('<div/>').addClass('label')).append(btnNext).append(btnLast).append($('<div/>').addClass('short').append(inputPage).append(btnGo));
